  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]">
        ...
        <p className="text-white text-[24px] leading-10 whitespace-wrap">
          Unleash the Power of Words, Connect with Like-minded Readers and
          Writers
        </p>
        <button className="bg-regal-blue py-4 px-12 text-white rounded-lg my-10 w-[14rem]">Get started</button>
